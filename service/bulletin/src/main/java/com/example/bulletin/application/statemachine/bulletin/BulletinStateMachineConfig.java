    ...
    public void configure(StateMachineTransitionConfigurer<BulletinState, BulletinEvent> transition)
        ...
        transition
                ...
                .withInternal()
                    .source(BulletinState.MODIFIABLE)
                    .guard(guards.checkIfUserIsOwnerGuard())
                    .action(actions.addImage(), errorAction())
                    .event(BulletinEvent.ADD_IMAGE)
                .and()
                .withInternal()
                    .source(BulletinState.MODIFIABLE)
                    .guard(guards.checkIfUserIsOwnerGuard())
                    .action(actions.removeImage(), errorAction())
                    .event(BulletinEvent.REMOVE_IMAGE)
                .and()
                .withInternal()
                    .source(BulletinState.MODIFIABLE)
                    .guard(guards.checkIfUserIsOwnerGuard())
                    .action(actions.setMainImage(), errorAction())
                    .event(BulletinEvent.SET_MAIN_IMAGE)
                .and()
