...
public class QueueContract {
    ...
    public static final String NOTIFICATION_USER_REGISTERED_QUEUE = "bulletin.user_registered_queue";
    public static final String NOTIFICATION_BULLETIN_PUBLISHED_QUEUE = "bulletin.bulletin_published_queue";
